...
//
// Starting code (don't modify this):
// make a new cosnt that references the indexes 
...
function addWords (noun = 'dog', adjective = 'orange') {
...
console.log(`${savedUserTheme} is provided to get you started`)
